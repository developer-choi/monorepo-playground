...
- 상태: 없음 (도입 안 함)
- 상황: 구분선 대신 UI 간 간격으로 해결. examples 사용처 0이라 컴포넌트를 두지 않는다.
...
- 참고: `src/components/feedback/modal/Alert.tsx`, `src/components/feedback/modal/Confirm.tsx`, 호출 패턴은 `apps/examples/docs/patterns/overlay/OverlayKitModal.md`
...
- **Board\***: Card/Form/Table/Detail/Filter/ListPage/Skeleton/TagInput — Card/Table/Badge/Confirm 조합 게시판 도메인.
